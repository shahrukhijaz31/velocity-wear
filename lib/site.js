...
// Hreflang region targets (same English content served to each region).
export const HREFLANG = ['en-US', 'en-GB', 'en-CA', 'en-AU', 'en-IE', 'en'];

export const FAQ_HOME = [
  {
    q: 'Do you ship custom apparel to the UK, USA and Canada?',
    a: 'Yes. Velocity Wear ships custom apparel worldwide with tracked delivery, including the United Kingdom, United States, Canada, Australia, the UAE and across Europe. Exact shipping cost and lead time are confirmed in your free quote.',
  },
  {
  ...
  },
  {
    ...
    a: 'Hoodies, t-shirts, polo shirts, caps, trousers, corporate uniforms and ecommerce merch — plus wholesale towels for gyms, spas and hotels. We also handle private-label manufacturing and bulk apparel production.',
  },
  {
