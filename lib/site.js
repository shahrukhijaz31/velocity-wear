...
/* ------------------------------------------------------------------ */
/*  WHOLESALE (all products) — UK, USA & Europe                        */
/* ------------------------------------------------------------------ */

export const WHOLESALE = {
  tagline: 'Premium wholesale custom apparel for brands, retailers, gyms & teams — shipped to the UK, USA & Europe.',
};

export const WHOLESALE_PRODUCTS = [
  { name: 'Custom Hoodies', icon: 'hoodie', href: '/wholesale/hoodies', desc: 'Heavyweight 380–450 GSM fleece, printed or embroidered.' },
  { name: 'T-Shirts', icon: 'tshirt', href: '/wholesale/t-shirts', desc: 'Combed ring-spun cotton with DTF & screen printing.' },
  { name: 'Polo Shirts', icon: 'polo', href: '/wholesale/polo-shirts', desc: 'Piqué cotton with crisp embroidered branding.' },
  { name: 'Caps & Headwear', icon: 'cap', href: '/wholesale/caps', desc: 'Snapbacks, dad caps & 3D puff embroidery.' },
  { name: 'Trousers & Joggers', icon: 'trousers', href: '/wholesale/joggers', desc: 'Cargos, joggers & matching tracksuit co-ords.' },
  { name: 'Denim Jackets', icon: 'jacket', href: '/wholesale/denim-jackets', desc: 'Premium washed denim with custom hardware & branding.' },
  { name: 'Corporate Uniforms', icon: 'uniform', href: '/wholesale/uniforms', desc: 'Head-to-toe staff kits with managed reorders.' },
  { name: 'Wholesale Towels', icon: 'droplets', href: '/wholesale-towels', desc: 'Gym, spa & hotel towels in custom GSM & sizes.' },
];

export const WHOLESALE_TIERS = [
  { range: '20 – 99', label: 'Starter', discount: 'Base wholesale pricing' },
  { range: '100 – 499', label: 'Growth', discount: 'Up to 20% off' },
  { range: '500 – 999', label: 'Volume', discount: 'Up to 30% off' },
  { range: '1,000+', label: 'Enterprise', discount: 'Up to 40% off' },
];

export const WHOLESALE_WHY = [
  { title: 'Low 20-Piece MOQ', desc: 'Test designs before scaling — the lowest premium minimum in the industry.', icon: 'box' },
  { title: 'Tiered Bulk Pricing', desc: 'Unit cost falls as you scale — up to 40% off at volume.', icon: 'tag' },
  { title: 'Premium Fabric Quality', desc: 'GSM-verified, pre-shrunk and colour-locked across every garment.', icon: 'gem' },
  { title: 'Full Custom Branding', desc: 'Woven labels, custom tags, packaging and private label.', icon: 'sparkles' },
  { title: 'UK, USA & Europe Delivery', desc: 'Tracked freight with clear landed-cost and duty guidance.', icon: 'truck' },
  { title: 'Managed Reorders', desc: 'We keep your specs on file so every reorder matches exactly.', icon: 'check' },
];

export const FAQ_WHOLESALE = [
  {
    q: 'Do you supply wholesale custom apparel to the UK, USA and Europe?',
    a: 'Yes. Velocity Wear supplies wholesale custom apparel — hoodies, t-shirts, polos, caps, trousers, denim jackets, corporate uniforms and towels — to brands, retailers, gyms and teams across the UK, USA and Europe, with tracked freight and clear landed costs.',
  },
  {
    q: 'What is the minimum order quantity for wholesale?',
    a: 'Just 20 pieces per design — one of the lowest premium MOQs available — so you can test before scaling. Tiered pricing rewards volume, with up to 40% off on runs of 1,000+ pieces.',
  },
  {
    q: 'How does wholesale pricing work?',
    a: 'Pricing is tiered by quantity: the more you order per design, the lower the unit cost, because setup is spread across more units. Send your product, quantity and artwork for a free, itemised quote.',
  },
  {
    q: 'Can you handle private label and custom branding on wholesale orders?',
    a: 'Absolutely — woven labels, custom neck tags, hang cards, branded packaging and full private label, so wholesale runs ship retail-ready under your own brand.',
  },
  {
    q: 'What are the lead times and shipping for UK, USA and Europe wholesale orders?',
    a: 'Most orders ship within about 7–14 days of mockup approval depending on quantity and decoration, with tracked freight to the UK, USA and Europe. Landed cost (including any duties and VAT) and lead time are confirmed in your quote.',
  },
  {
    q: 'Who do you supply wholesale apparel to?',
    a: 'Ecommerce and streetwear brands, retailers and resellers, gyms and studios, events, corporates and institutions — anyone needing premium custom apparel in bulk.',
  },
];
