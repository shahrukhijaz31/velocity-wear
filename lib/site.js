...
export const WHOLESALE_PRODUCTS = [
  { name: 'Custom Hoodies', icon: 'hoodie', desc: 'Heavyweight 380–450 GSM fleece, printed or embroidered.' },
  { name: 'T-Shirts', icon: 'tshirt', desc: 'Combed ring-spun cotton with DTF & screen printing.' },
  { name: 'Polo Shirts', icon: 'polo', desc: 'Piqué cotton with crisp embroidered branding.' },
  { name: 'Caps & Headwear', icon: 'cap', desc: 'Snapbacks, dad caps & 3D puff embroidery.' },
  { name: 'Trousers & Joggers', icon: 'trousers', desc: 'Cargos, joggers & matching tracksuit co-ords.' },
  { name: 'Denim Jackets', icon: 'jacket', desc: 'Premium washed denim with custom hardware & branding.' },
  { name: 'Corporate Uniforms', icon: 'uniform', desc: 'Head-to-toe staff kits with managed reorders.' },
  { name: 'Wholesale Towels', icon: 'droplets', desc: 'Gym, spa & hotel towels in custom GSM & sizes.' },
];
