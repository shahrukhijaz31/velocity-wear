...
export const organizationLd = {
  ...
  description:
    'Premium custom apparel printing and wholesale towels for gyms, spas and hotels — shipped worldwide including the UK, USA and Europe.',
  ...
  knowsAbout: [
    ...
    'Wholesale apparel UK USA Europe',
  ],
  contactPoint: {
    '@type': 'ContactPoint',
    contactType: 'sales',
